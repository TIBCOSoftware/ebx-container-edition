...
is not recommended for production use? TODO pch review
...
Otherwise, you can install ebx in the same namespace as your postgresql server to avoid this problem.
